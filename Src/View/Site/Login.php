...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="../../Template/dist/img/favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon" href="../../Template/dist/img/apple-touch-icon.png">
</head>
<!-- End Head -->
...
<body>
    ...
    <header class="navbar-fixed-top s-header js__header-sticky js__header-overlay">
        ...
        <div class="s-header-bg-overlay js__bg-overlay">
            ...
            <ul class="list-inline s-header__action s-header__action--lb">
                <li class="s-header__action-item"><a class="s-header__action-link -is-active" href="#">PT</a></li>
            ...
            <div class="row g-hor-centered-row--md g-margin-t-30--xs g-margin-t-20--sm">
                <div class="col-lg-6 col-sm-6 g-hor-centered-row__col g-text-center--xs g-text-left--md g-margin-b-60--xs g-margin-b-0--md">
                    <div class="s-promo-block-v1__square-effect g-margin-b-60--xs">
                        <h1 class="g-font-size-32--xs g-font-size-45--sm g-font-size-50--lg g-color--white">Acesse seu Painel .<br></h1>
                        <p class="g-font-size-20--xs g-font-size-26--md g-color--white g-margin-b-0--xs">Ainda não é cadastrado ?<br>consulte um consultor.</p>
                    </div>
                    ...
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <form class="center-block g-width-350--xs g-bg-color--white-opacity-lightest g-box-shadow__blueviolet-v1 g-padding-x-40--xs g-padding-y-60--xs g-radius--4">
                            <div class="g-text-center--xs g-margin-b-40--xs">
                                <h2 class="g-font-size-30--xs g-color--white">Fazer Login</h2>
                            </div>
                            ...
                            <div class="g-text-center--xs">
                                <button type="submit" class="text-uppercase btn-block s-btn s-btn--md s-btn--white-bg g-radius--50 g-padding-x-50--xs g-margin-b-20--xs">Logar</button>
                                <a class="g-color--white g-font-size-13--xs" href="#">Esqueceu Sua Senha ?</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="../../Template/dist/js/components/portfolio-4-col-slider.min.js"></script>
