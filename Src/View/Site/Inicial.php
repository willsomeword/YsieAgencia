...
<head>
    ...
    <link href="../../Template/dist/css/animate.css" rel="stylesheet" type="text/css" />
    ...
    <link href="../../Template/dist/css/global/global.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <header class="navbar-fixed-top s-header js__header-sticky js__header-overlay">
                    ...
                    <div class="s-header__navbar-row-col">
                        ...
                        <div class="s-header__logo">
                            <a href="index.html" class="s-header__logo-link">
                                <img class="s-header__logo-img s-header__logo-img-default" src="../../Template/dist/img/logo-remove.png" alt="Logo">
                                <img class="s-header__logo-img s-header__logo-img-shrink" src="../../Template/dist/img/logo-removebg-preview.png" alt="Logo">
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
        ...
        <div class="s-header-bg-overlay js__bg-overlay">
            ...
            <nav class="s-header__nav js__scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="list-unstyled s-header__nav-menu">
                        <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="../Site/Contato.php">Contato</a></li>
            ...
            <ul class="list-inline s-header__action s-header__action--lb">
                ...
                <li class="s-header__action-item"><a class="s-header__action-link" href="#">Pt</a></li>
            </ul>
            <!-- End Action -->
    ...
    <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
        <div class="g-text-center--xs g-margin-b-100--xs">
            <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Bem vido Ysie</p>
            <h2 class="g-font-size-32--xs g-font-size-36--md">Criamos <br> Experiencias que impulsionam o crescimento do seu Negocio.</h2>
        </div>
        <div class="row g-margin-b-60--xs g-margin-b-70--md">
            ...
            <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Desenvolvimento de Sites</h3>
                        <p class="g-margin-b-0--xs">Criação de sites personalizados, desenvolvidos de acordo com as necessidades e perfil do cliente, sem o uso de frameworks pré-definidos.</p>
                    </div>
                </div>
            </div>
            <!-- Apps -->
            <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Desenvolvimento de Apps</h3>
                        <p class="g-margin-b-0--xs">Desenvolvimento de aplicativos móveis e web, com design personalizado e funcionalidades avançadas para atender às necessidades do seu negócio.</p>
                    </div>
                </div>
            </div>
            <!-- Landing Page -->
            <div class="col-sm-4">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Landing Pages</h3>
                        <p class="g-margin-b-0--xs">Criação e otimização de landing pages para maximizar conversões e resultados de campanhas, com design atraente e chamadas à ação eficazes.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Social Media</h3>
                        <p class="g-margin-b-0--xs">Gerenciamento de redes sociais com criação de conteúdo, design gráfico, e estratégias para aumentar o engajamento e a presença online.</p>
                    </div>
                </div>
            </div>
            <!-- Gestão de Tráfego -->
            <div class="col-sm-4 g-margin-b-60--xs g-margin-b-0--md">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Gestão de Tráfego Pago</h3>
                        <p class="g-margin-b-0--xs">Criação e otimização de campanhas de tráfego pago para gerar leads qualificados e maximizar o retorno sobre investimento (ROI) em plataformas como Google Ads e redes sociais.</p>
                    </div>
                </div>
            </div>
            <!-- Designer -->
            <div class="col-sm-4">
                <div class="clearfix">
                    ...
                    <div class="g-media__body g-padding-x-20--xs">
                        <h3 class="g-font-size-18--xs">Design Gráfico</h3>
                        <p class="g-margin-b-0--xs">Criação de materiais gráficos personalizados, incluindo logotipos, banners, e outros elementos visuais para fortalecer a identidade da sua marca.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--xsm">
        <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
            <div class="col-sm-5 g-hor-centered-row__col">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Sobre o que produzimos</h2>
                <p class="g-font-size-18--sm">Escalamos seu Negocio com Sistema proprio, feito por Devs e profissionais que buscam entender todo panorama indepedente de seu segmento.</p>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-5 g-hor-centered-row__col">
                <img class="img-responsive" src="../../Template/dist/img/mockups/iphone-03.png" alt="Mockup Image">
            </div>
        </div>
        <div class="row g-hor-centered-row--md g-row-col--5">
            <div class="col-sm-5 col-sm-push-7 g-hor-centered-row__col">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">Melhore sua Marca e como seus cliente o veem.</h2>
                <p class="g-font-size-18--sm">Trabalhamos com equipe especializada e focada em melhoria da marca e implementação de metas para atingir todos resultados possiveis.</p>
            </div>
            <div class="col-sm-1"></div>
            <div class="col-sm-5 col-sm-pull-7 g-hor-centered-row__col g-text-left--xs g-text-right--md">
                <img class="img-responsive" src="../../Template/dist/img/mockups/iphone-02.png" alt="Mockup Image">
            </div>
        </div>
    </div>
    <!-- End Mockup -->
    ...
    <section class="s-video__bg" data-vidbg-bg="mp4: include/media/mp4_video.mp4, webm: include/media/webm_video.webm, poster: include/media/fallback.jpg" data-vidbg-options="loop: true, muted: true, overlay: false">
        <div class="container g-position--overlay g-text-center--xs">
            <div class="g-padding-y-50--xs g-margin-t-50--xs g-margin-t-100--sm g-margin-b-100--xs g-margin-b-250--md">
                <h2 class="g-font-size-36--xs g-font-size-50--sm g-font-size-60--md g-color--white">Muito mais do que apenas,</h2>
                <h2 class="g-font-size-36--xs g-font-size-50--sm g-font-size-60--md g-color--white">Uma Agencia.</h2>
            </div>
        </div>
    </section>
    <!-- End Video -->
    ...
    <div class="container g-margin-t-o-100--xs g-margin-t-o-230--md">
        <div class="center-block s-mockup-v1">
            <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                <img class="img-responsive" src="../../Template/dist/img/mockups/devices-01.png" alt="Mockup Image">
            </div>
        </div>
    </div>
    <!-- End Mockup -->
                ...
                <div id="js__grid-portfolio-gallery" class="s-portfolio__paginations-v1 cbp">
                    ...
                    <div class="s-portfolio__item cbp-item motion graphic">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/04.jpg" alt="Portfolio Image">
                        </div>
                    ...
                    <div class="s-portfolio__item cbp-item logos graphic">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/09.jpg" alt="Portfolio Image">
                        </div>
                        <div class="s-portfolio__caption-hover--cc">
                            <div class="g-margin-b-25--xs">
                            ...
                            <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                <li>
                                    <a href="../../Template/dist/img/970x647/09.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
                                        <i class="ti-fullscreen"></i>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="s-portfolio__item cbp-item logos motion">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/05.jpg" alt="Portfolio Image">
                        </div>
                        <div class="s-portfolio__caption-hover--cc">
                            <div class="g-margin-b-25--xs">
                                <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
                            ...
                            <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                <li>
                                    <a href="../../Template/dist/img/970x647/05.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
                                        <i class="ti-fullscreen"></i>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="s-portfolio__item cbp-item graphic">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/06.jpg" alt="Portfolio Image">
                        </div>
                        <div class="s-portfolio__caption-hover--cc">
                            <div class="g-margin-b-25--xs">
                                <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
                            ...
                            <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                <li>
                                    <a href="../../Template/dist/img/970x647/06.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
                                        <i class="ti-fullscreen"></i>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="s-portfolio__item cbp-item logos">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/07.jpg" alt="Portfolio Image">
                        </div>
                        <div class="s-portfolio__caption-hover--cc">
                            <div class="g-margin-b-25--xs">
                                <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
                            ...
                            <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                <li>
                                    <a href="../../Template/dist/img/970x647/07.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
                                        <i class="ti-fullscreen"></i>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="s-portfolio__item cbp-item motion graphic">
                        <div class="s-portfolio__img-effect">
                            <img src="../../Template/dist/img/970x647/08.jpg" alt="Portfolio Image">
                        </div>
                        <div class="s-portfolio__caption-hover--cc">
                            <div class="g-margin-b-25--xs">
                                <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Portfolio Item</h4>
                            ...
                            <ul class="list-inline g-ul-li-lr-5--xs g-margin-b-0--xs">
                                <li>
                                    <a href="../../Template/dist/img/970x647/08.jpg" class="cbp-lightbox s-icon s-icon--sm s-icon--white-bg g-radius--circle" data-title="Portfolio Item <br/> by KeenThemes Inc.">
                                        <i class="ti-fullscreen"></i>
                                    </a>
                                </li>
                                <li>
    ...
    <div class="g-bg-color--sky-light">
        <div class="container g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="g-text-center--xs g-margin-b-80--xs">
                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2 g-margin-b-25--xs">Planos</p>
                <h2 class="g-font-size-32--xs g-font-size-36--md">Descubra o Plano Pra sua Empresa</h2>
            </div>
                ...
                <div class="col-md-4 g-margin-b-10--xs g-margin-b-0--lg">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                            ...
                            <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">Plano Básico</h3>
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Gerenciamento de até 1 Projetos</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> 1 Landing Pages </li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Social Media para 1 Redes Sociais</li>
                ...
                <div class="col-md-4 g-margin-b-10--xs g-margin-b-0--lg">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".2s">
                        <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                            ...
                            <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">Plano Intermediário</h3>
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Gerenciamento de até 2 Projetos</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> 2 Landing Pages</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Social Media para 2 Redes Sociais</li>
                ...
                <div class="col-md-4">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".3s">
                        <div class="s-plan-v1 g-text-center--xs g-bg-color--white g-padding-y-100--xs">
                            ...
                            <h3 class="g-font-size-18--xs g-color--primary g-margin-b-30--xs">Plano Avançado</h3>
                            <ul class="list-unstyled g-ul-li-tb-5--xs g-margin-b-40--xs">
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Gerenciamento Ilimitado de Projetos</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Landing Pages Ilimitadas</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Social Media Completa</li>
                                <li><i class="g-font-size-13--xs g-color--primary g-margin-r-10--xs ti-check"></i> Consultoria Ilimitada</li>
    ...
    <!-- Parallax -->
    <div class="js__parallax-window" style="background: url(../../Template/dist/img/1920x1080/03.jpg) 50% 0 no-repeat fixed;">
        <div class="container g-text-center--xs g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-margin-b-80--xs">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white">Cadastre e descubra como podemos ajudar .</h2>
            </div>
            <a href="" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50">Cadastrar</a>
        </div>
    </div>
    <!-- End Parallax -->
    ...
    <script type="text/javascript" src="../../Template/dist/js/global.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/header-sticky.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/scrollbar.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/magnific-popup.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/swiper.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/counter.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/portfolio-3-col.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/parallax.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/google-map.min.js"></script>
    <script type="text/javascript" src="../../Template/dist/js/components/wow.min.js"></script>
    <!--========== END JAVASCRIPTS ==========-->
